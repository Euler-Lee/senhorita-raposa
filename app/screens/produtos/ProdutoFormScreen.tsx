...
const styles = StyleSheet.create({
  ...
  removeBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#FEE2E2', justifyContent: 'center', alignItems: 'center', marginLeft: 8 },
  removeTxt: { color: '#C0392B', fontWeight: '800', fontSize: 14 },
